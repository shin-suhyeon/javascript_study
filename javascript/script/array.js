...
//콘솔 결과 예) 좋아하는 색상은 0,0이2 입니다.
let color = []
console.log(color)
color = ['red', 'orange' , 'yellow','green','blue','purple']
console.log(color)
console.log(`좋아하는 색상은 ${color[2]},${color[5]}입니다`)
//2. 좋아하는 과일 5개 배열로 저장하고 모두 역순으로 출력해보세요
const fruit = ['딸기','사과','바나나','포도','망고']
...
lottecinema.push('A2')
console.log(lottecinema)
lottecinema.push('A23')
console.log(lottecinema)
lottecinema.push('A7')
console.log(lottecinema)
lottecinema.push('A11')
console.log(total)
//뒤로 가기 인원 수정
lottecinema.pop()
//결제 하기 클릭 후 메세지 출력
